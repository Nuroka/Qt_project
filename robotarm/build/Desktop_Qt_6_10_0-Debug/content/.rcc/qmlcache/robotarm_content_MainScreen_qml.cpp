...
namespace _content_MainScreen_qml {
...
0x70,0x5,0x0,0x0,0x4d,0x3b,0xe9,0x49,
0x73,0x4b,0x99,0x12,0x4c,0x87,0xea,0xe5,
0x3b,0xa,0x4c,0xcf,0x0,0x0,0x0,0x0,
0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,
...
0x7,0x12,0xd,0x18,0xa,0x14,0x0,0xb,
0xac,0x2,0x7,0x2,0xa,0x18,0x6,0xd4,
...
s.v2_5 = QStringLiteral("127.0.0.1");
{
}
// generate_StoreReg
{
...
// generate_MoveConst
s.v11_9 = ushort(20001);
{
}
// generate_CallPropertyLookup
{
const auto doCall = [&]() {
    void *args[] = {nullptr, &s.v2_5, &s.v11_9};
    return aotContext->callObjectPropertyLookup(2, s.v2_1, args, 2);
};
const auto doInit = [&]() {
    aotContext->initCallObjectPropertyLookup(2, s.v2_1, 9);
};
#ifndef QT_NO_DEBUG
