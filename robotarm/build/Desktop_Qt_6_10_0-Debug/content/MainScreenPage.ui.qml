...
Pane {
    ...
    ColumnLayout {
        ...
        LabeledSlider {
            ...
            from: -135
            to: 135
            // Backend의 rotation2Angle을 항상 따라가도록
            value: backendProp.rotation2Angle

            // 사용자가 슬라이더를 건드리면 Backend 쪽 값 갱신
        ...
        LabeledSlider {
            ...
            from: -180
            to: 180
            value: backendProp.rotation4Angle
            onMoved: backendProp.rotation4Angle = value
        }
    }
    ...
    View3D {
        ...
        Node {
            ...
            RoboticArm {
                ...
                rotation4: backendProp.rotation4Angle
